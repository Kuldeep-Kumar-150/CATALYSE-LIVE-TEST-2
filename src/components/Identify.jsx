        ...
        <section className='py-5 position-relative'>
            <Container className=' custom_container'>
                ...
                <Row className=' justify-content-center'>
                    <Col sm={6}lg={4} className='text-center mt-5 mt-sm-0'>
                    ...
                    <Col sm={6}lg={4} className='text-center mt-5 mt-sm-0 pt-sm-0'>
                    ...
                    <Col sm={6}lg={4} className='text-center mt-5 mt-lg-0'>
