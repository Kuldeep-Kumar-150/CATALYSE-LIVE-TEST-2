...
const MyNav = () => {
  ...
  return (
    <section className='bg-white py-4 m-sm-3 rounded-3'>
        ...
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div className={nav === false ? "d-flex flex-column align-items-center justify-content-center text-center hide_nav d-lg-none " : " d-lg-none open_nav  d-flex flex-column align-items-center justify-content-center text-center"}>
            <div className='d-flex flex-column'>
              <a onClick={() => setNav(true)} href="#" className='fs_sm text-black fw-semibold d-flex align-items-center'><img className='me-2' src={finance} alt="finance" />Financial Services</a>
              <a onClick={() => setNav(true)} href="#" className='fs_sm text-black fw-semibold d-flex align-items-center my-3'><img className='me-2' src={realEstate} alt="finance" />Real Estate</a>
            </div>
            <div className='d-flex flex-column'>
              <a onClick={() => setNav(true)} href="/" className='fs_sm fw-semibold text_green signup_nav_btn d-inline-block'>Sign up</a>
              <a onClick={() => setNav(true)} href="/" className='fs_sm fw-semibold text_green login_nav_btn d-inline-block mt-3'>Log in
